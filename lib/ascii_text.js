...
function buildStyle1(inputText) {
    let newline = false; let line0 = ""; let line1 = ""; let line2 = ""; let line3 = ""; let space = "    "; let a = new Array(4); let b = new Array(4); let c = new Array(4); let d = new Array(4); let e = new Array(4); let f = new Array(4); let g = new Array(4); let h = new Array(4); let I = new Array(4); let j = new Array(4); let k = new Array(4); let l = new Array(4); let m = new Array(4); let n = new Array(4); let o = new Array(4); let p = new Array(4); let q = new Array(4); let r = new Array(4); let s = new Array(4); let t = new Array(4); let u = new Array(4); let v = new Array(4); let w = new Array(4); let x = new Array(4); let y = new Array(4); let z = new Array(4); let zero = new Array(4); let one = new Array(4); let two = new Array(4); let three = new Array(4); let four = new Array(4); let five = new Array(4); let six = new Array(4); let seven = new Array(4); let eight = new Array(4); let nine = new Array(4);
    ...
    let outputText = line0+"\n"+line1+"\n"+line2+"\n"+line3;
    if(newline == true) {
        return outputText + '\n' + buildStyle1(inputText.substring((i+2),inputText.length));
    } else {
        return outputText;
    }
}
...
function buildStyle2(inputText) {
    let newline = false; let line0 = ""; let line1 = ""; let line2 = ""; let line3 = ""; let line4 = ""; let line5 = ""; let space = "     "; let a = new Array(6); let b = new Array(6); let c = new Array(6); let d = new Array(6); let e = new Array(6); let f = new Array(6); let g = new Array(6); let h = new Array(6); let I = new Array(6); let j = new Array(6); let k = new Array(6); let l = new Array(6); let m = new Array(6); let n = new Array(6); let o = new Array(6); let p = new Array(6); let q = new Array(6); let r = new Array(6); let s = new Array(6); let t = new Array(6); let u = new Array(6); let v = new Array(6); let w = new Array(6); let x = new Array(6); let y = new Array(6); let z = new Array(6); let zero = new Array(6); let one = new Array(6); let two = new Array(6); let three = new Array(6); let four = new Array(6); let five = new Array(6); let six = new Array(6); let seven = new Array(6); let eight = new Array(6); let nine = new Array(6);
    ...
    let outputText = line0+"\n"+line1+"\n"+line2+"\n"+line3+"\n"+line4+"\n"+line5;
    if(newline == true) {
        return outputText + '\n' + buildStyle2(inputText.substring((i+2),inputText.length));
    } else {
        return outputText;
    }
}
...
function buildStyle3(inputText,booleanRepeat) {
    let newline = false; let line0 = ""; let line1 = ""; let line2 = ""; let space = "  "; let a = new Array(3); let b = new Array(3); let c = new Array(3); let d = new Array(3); let e = new Array(3); let f = new Array(3); let g = new Array(3); let h = new Array(3); let I = new Array(3); let j = new Array(3); let k = new Array(3); let l = new Array(3); let m = new Array(3); let n = new Array(3); let o = new Array(3); let p = new Array(3); let q = new Array(3); let r = new Array(3); let s = new Array(3); let t = new Array(3); let u = new Array(3); let v = new Array(3); let w = new Array(3); let x = new Array(3); let y = new Array(3); let z = new Array(3); let zero = new Array(3); let one = new Array(3); let two = new Array(3); let three = new Array(3); let four = new Array(3); let five = new Array(3); let six = new Array(3); let seven = new Array(3); let eight = new Array(3); let nine = new Array(3);
    a[0] = "/¯\\ ";		a[1] = "|¯| ";		a[2] = "    ";
    b[0] = "|¯/ ";		b[1] = "|¯/ ";		b[2] = " ¯  ";
    c[0] = "|¯ ";		c[1] = "|_ ";		c[2] = "   ";
    d[0] = "|¯\\ ";		d[1] = "|_/ ";		d[2] = "    ";
    ...
    let outputText = line0+"\n"+line1+"\n"+line2;
    if(newline == true) {
        return outputText + '\n' + buildStyle3(inputText.substring((i+2),inputText.length));
    } else {
        return outputText;
    }
}

exports.buildStyle1 = buildStyle1;
exports.buildStyle2 = buildStyle2;
exports.buildStyle3 = buildStyle3;